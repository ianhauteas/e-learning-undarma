...
<head>
    ...
    <title>Tentang Developer E-Learning Udarma</title>
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper">
            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="<?= base_url('admin') ?>" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 30px;" class="fas fa-graduation-cap"></i> |
                                E-Learning <sup></sup> </a>
                        </div>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('admin') ?>">ian</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li class="menu-header">Management Mahaiswa</li>
                        <li class="nav-item dropdown">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="section-header">
                        <h1 style="font-size: 27px; letter-spacing:-0.5px; color:black;">Tentang E-Learning Undarma </h1>
                    </div>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                <h2 class="card-title" style="color: black;">Tentang E-Learning Undarma</h2>
                                <hr>
                                <p class="card-text">Web Edukasi Open Source yang dibuat oleh Pejuang skripsi 2020. <br> E-Learning Undarma adalah Web edukasi yang dilengkapi video, materi dan sistem ujian yang tersedia secara gratis. <br> E-Learning Undarma dibuat ditujukan agar para siswa dan guru dapat terus belajar dan mengajar dimana saja dan kapan saja. </p>
                            </div>
                        </div>
                    </div>
                </section>
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2020 <div class="bullet"></div><a href="#">pejuang skripsi 2020</a>
                </div>
            </footer>
            <!-- End Footer -->
