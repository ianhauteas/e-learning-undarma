...
<head>
    ...
    <title>Tambah Data Materi - E-Learning Undarma </title>
    <!-- General CSS Files -->
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Admin E-Learning Undarma</div>
                    ...
                    <div class="sidebar-brand text-danger">
                        <div>
                            <a href="<?= base_url('admin') ?>" style="font-size: 30px;font-weight:900;font-family: 'Poppins', sans-serif;" class="text-success text-center"><i style="font-size: 30px;" class="fas fa-graduation-cap"></i> |
                                E-Learning Undarma </a>
                        </div>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="<?= base_url('admin') ?>">EU</a>
                    </div>
                                        ...
                                        <form method="post" enctype="multipart/form-data" action="<?= base_url('guru/add_materi') ?>">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <small>List Dosen sudah tersedia di autocomplete, kalian hanya
                                                        tinggal klik input area nya atau dengan cara menulis namanya dan
                                                        klik dosen yang akan dipilih.</small>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nama_mapel" id="nama_mapel" required placeholder="Pilih nama Dosen yang valid agar nama mapel muncul" readonly>
                                                <small>Jika nama matkul sudah berganti artinya nama guru yang kamu
                                                    masukan di input area adalah valid! jika tidak muncul nama matkul
                                                    anda harus klik input area nama Dosen dan pilih guru yang tersedia
                                                    disana.</small>
                                            </div>
                                            <div class="form-group">
